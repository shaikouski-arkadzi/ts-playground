...
const player1: Player<number> = {
  game: "CS:GO",
  hours: 300,
  server: "basic",
};

const player2: Player<string> = {
  game: 2048,
  hours: "300 h.",
  server: "arcade",
};

const player3: Player<{ total: number; inMenu: number }> = {
  game: "Chess",
  hours: {
    total: 500,
    inMenu: 50,
...
function calculateAmountOfFigures(figure: Data[]): AmountOfFigures {
